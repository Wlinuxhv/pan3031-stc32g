...
// 
// FIX: Removed conflicting macro definitions (OK/FAIL/SUCCESS)
// These are now defined in pan3031.h to avoid conflicts

#define _nop_() __asm__("nop")

// ============================================================================
// FIX: Conditionally define types to avoid conflict with stdint.h
// Only define if not already defined by compiler/standard headers
// ============================================================================
#ifndef __SDCC_STDINT_INCLUDED
...
// ============================================================================
// FIX: Removed SUCCESS/FAIL definitions - now only in pan3031.h
// This prevents macro redefinition conflicts
// ============================================================================
...
// ============================================================================
// FIX: Added interrupt function compatibility macro
// Use INTERRUPT(n) instead of interrupt n for cross-compiler compatibility
// ============================================================================
#ifdef __SDCC__
